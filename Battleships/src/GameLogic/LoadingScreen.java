...
public class LoadingScreen implements Screen{
	...
	public LoadingScreen(Main m){
		...
		Texture bg = AssetStorage.manager.get("data/LoadingScreen.png",Texture.class);
	...
	public void loadGuiObjects(){
		AssetStorage.manager.load("data/guiobjects/arrow_left.png",Texture.class);
		AssetStorage.manager.load("data/guiobjects/arrow_right.png",Texture.class);
