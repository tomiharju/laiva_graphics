...
public class NavalGunStrategy implements WeaponStrategy{
	...
	public NavalGunStrategy(ObjectController parent) {
		this.parent=parent;
	...
	public void dealDamage(Vector3 point,ProjectileRenderer renderer) {
		...
		for (ShipController ship : hits) {
			((ShipObject) ship.getObject()).dealDamage(new DamageCalculator(point,RADIUS,(ShipObject) ship.getObject()).calculate());
		}
		}
		else
